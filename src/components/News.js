...
import CusSpinner from './CusSpinner';
...
export class News extends Component {
  ...
  render() {
    return (
  <>
        <h1 className="text-center" style={{ margin: '35px 0px' }}>NewsMaster - Top {this.capitalizeFirstLetter(this.props.category)} Headlines </h1>
